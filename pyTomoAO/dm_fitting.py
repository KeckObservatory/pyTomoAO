...
It includes methods for computing influence functions, generating fitting matrices,
and fitting OPD maps.
"""
...
class fitting:
    ...
    def __setattr__(self, name, value):
        ...
        if name in [
            ...
            "resolution",
            "_fitting_matrix",
            "_influence_functions",
        ] or not hasattr(self, "dmGeometry"):
    ...
    def double_gaussian_influence(
        self, x, y, center_x=0, center_y=0, w1=2, w2=-1, sigma1=0.54, sigma2=0.85
    ):
        """
    ...
    def create_influence_grid(self, grid_shape, actuator_pos, w1=2, w2=-1, sigma1=0.5, sigma2=0.85):
        ...
        return self.double_gaussian_influence(x, y, center_x, center_y, w1, w2, sigma1, sigma2)
    ...
    def map_actuators_to_new_grid(
        self, actuator_coords, original_shape, new_shape, stretch_factor=1.03
    ):
        """
    ...
    def set_influence_function(
        ...
        for i in range(dmParams.validActuators.sum()):
            ...
            IF = self.create_influence_grid(
                (resolution, resolution), new_actuator_coords[i], w1, w2, sigma1, sigma2
            )
