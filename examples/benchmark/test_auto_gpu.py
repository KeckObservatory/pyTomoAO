...
def calculate_scaled_shifted_coords_gpu(
    x_gpu,
    y_gpu,
...
def build_reconstructor_gpu(
    ...
    with stream:
        ...
        Cox = cross_correlation_gpu(
            tomoParams, lgsWfsParams, atmParams, lgsAsterismParams, use_float32=use_float32
        ).astype(dtype)
        cp.get_default_memory_pool().free_all_blocks()  # Free memory after Cxx computation
