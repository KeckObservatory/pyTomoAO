...
lgsWfsParams.wfs_lenslets_offset = np.array([[0.23/24,-0.23/24,-0.23/24,0.23/24],\
...
# Test invCss matrix
mat_data = loadmat('/Users/urielconod/tomographyDataTest/invCss_inv.mat')
...
mat_data = loadmat('/Users/urielconod/tomographyDataTest/phase_3.mat')
phase_3 = mat_data['phase_3']
